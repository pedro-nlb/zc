...
The real $2$-sphere is birational to the real plane under the stereographic projection, so the fraction field of $A$ is isomorphic to $\R(x,y)$, hence also a formally real domain.
