...
If we take the tubular neighbourhood theorem \cite[Thm.~II.11.4]{bre93} and the Lefschetz--Hopf fixed point theorem \cite[Thm.~IV.23.4]{bre93} for granted, we can prove a much more general statement:

\begin{thm}[{\cite[Cor.~IV.23.6]{bre93}}]
